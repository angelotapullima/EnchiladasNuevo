...
class ProductoDatabase{
  ...
  insertarProductosDb(ProductosData productos) async {
    ...
    final res = await db.rawInsert(
        'INSERT OR REPLACE INTO Producto (id_producto,id_categoria,producto_nombre,producto_foto,producto_orden,producto_precio,producto_sonido,'
        ...
        ' "${productos.productoFoto}" ,"${productos.productoOrden}" , "${productos.productoPrecio}" , "${productos.sonido}" ,"${productos.productoUnidad}" ,'
