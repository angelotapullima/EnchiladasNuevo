...
class DetallePromocionesLocal extends StatefulWidget {
  ...
  @override
  _DetallePromocionesLocalState createState() => _DetallePromocionesLocalState();
}
              ...
              if (snapshot.data.length > 0) {
                var titulo = Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: responsive.ip(3), fontFamily: 'Montserrat', fontWeight: FontWeight.bold),
                  ),
                );
                return Column(
                  children: <Widget>[
