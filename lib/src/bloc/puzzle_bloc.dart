...
class PuzzleBloc{
  ...
  Stream<List<RankingPuzzle>> get puzzleTiempoStream => _puzzleTiemposController.stream;
  ...
  void obtenerTiempos( String fecha)async{
    _puzzleTiemposController.sink.add(await rankingDatabase.obtenerRankingPorFecha(fecha));
