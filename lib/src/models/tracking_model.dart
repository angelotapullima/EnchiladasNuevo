...
class TrackingData {
    TrackingData({
        ...
        @required this.pedidoTipoComprobante,
        @required this.pedidoCodPersona,
        @required this.pedidoFecha,
        @required this.pedidoHora,
        @required this.pedidoTotal,
        @required this.pedidoTelefono,
        @required this.pedidoDni,
        @required this.pedidoX,
        @required this.pedidoY,
        @required this.pedidoNombre,
        @required this.pedidoDireccion,
        @required this.pedidoReferencia,
        @required this.pedidoFormaPago,
        @required this.pedidoMontoPago,
        @required this.pedidoVueltoPago,
        @required this.pedidoEstadoPago,
        @required this.pedidoEstado,
        @required this.pedidoCodigo,
        @required this.idEntrega,
        @required this.idRepartidor,
        @required this.idVehiculo,
        @required this.entregaFechaInicio,
        @required this.entregaHoraInicio,
        @required this.entregaFechaFin,
        @required this.entregaHoraFin,
        @required this.idTracking,
        @required this.trackingX,
        @required this.trackingY,
        @required this.trackingFecha,
        @required this.trackingHora,
